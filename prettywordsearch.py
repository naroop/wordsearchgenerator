...
def generateWordSearch():
    ...
    print("If you don't like your word search, try re-running. It is generated randomly, so the next time it should be completely different, even with the same words.")
